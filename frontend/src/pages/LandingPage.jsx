...
const LandingPage = () => {
  ...
  return (
    <div className="font-sans text-gray-900 relative overflow-hidden">
      ...
      <div 
        className="fixed pointer-events-none z-50 w-96 h-96 bg-linear-to-r from-indigo-500/30 to-purple-500/30 rounded-full blur-3xl mix-blend-multiply transition-transform duration-700 ease-out will-change-transform"
        style={{
