...
const WeeklyGoals = () => {
    ...
    // Default safe values if data is null (though we handle null above)
    ...
    const dietTarget = data ? data.diet.target : 0;
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col justify-center items-center h-full">
